...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=lubbock&box=-101.747053,33.698015,-102.016988,33.473437
...
-----------
  ...
  * lubbock Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * lubbock Height Map (SRTM3 v4.1).png
  ...
  * lubbock Height Map (SRTM30 Plus).png
  ...
  * lubbock Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 859m (actual) is equal to 40m in
